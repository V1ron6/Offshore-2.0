...
const mockProducts = [
	...
	// ========================================
	{
		...
		subcategory: 'spreads',
		stock: 120,
		image: 'https://images.unsplash.com/photo-1612187264498-342c0117db03?w=500&h=500&fit=crop',
		rating: 4.7,
		reviews: 234,
		sku: 'FOOD-001',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'seafood',
		stock: 45,
		image: 'https://images.unsplash.com/photo-1574781330855-d0db8cc6a79c?w=500&h=500&fit=crop',
		rating: 4.8,
		reviews: 198,
		sku: 'FOOD-007',
		inStock: true,
	...
	},
	{
		...
		stock: 110,
		image: 'https://images.unsplash.com/photo-1600788886242-5c96aabe3757?w=500&h=500&fit=crop',
		rating: 4.5,
		reviews: 203,
		sku: 'FOOD-010',
		inStock: true,
	...
	},
	{
		...
		stock: 85,
		image: 'https://images.unsplash.com/photo-1583845112239-97ef1341b271?w=500&h=500&fit=crop',
		rating: 4.6,
		reviews: 267,
		sku: 'HOME-003',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'body',
		stock: 120,
		image: 'https://images.unsplash.com/photo-1594125311687-3b1b3eefa9f2?w=500&h=500&fit=crop',
		rating: 4.4,
		reviews: 203,
		sku: 'PC-002',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'snacks',
		stock: 110,
		image: 'https://images.unsplash.com/photo-1536591048421-99fc1bcebb20?w=500&h=500&fit=crop',
		rating: 4.7,
		reviews: 203,
		sku: 'FOOD-015',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'cooling',
		stock: 38,
		image: 'https://images.unsplash.com/photo-1527443060795-0402a218799b?w=500&h=500&fit=crop',
		rating: 4.7,
		reviews: 145,
		sku: 'ACC-003',
		inStock: true,
	...
	// ========================================
	{
		...
		subcategory: 'dental',
		stock: 150,
		image: 'https://images.unsplash.com/photo-1559056199-5c3e1e49eb79?w=500&h=500&fit=crop',
		rating: 4.4,
		reviews: 212,
		sku: 'PC-004',
		inStock: true,
	...
	},
	{
		...
		stock: 98,
		image: 'https://images.unsplash.com/photo-1618577055139-49b3d218efa7?w=500&h=500&fit=crop',
		rating: 4.5,
		reviews: 234,
		sku: 'DEV-006',
		inStock: true,
	...
	// ========================================
	{
		...
		subcategory: 'produce',
		stock: 180,
		image: 'https://images.unsplash.com/photo-1584306670957-acf935f5033c?w=500&h=500&fit=crop',
		rating: 4.6,
		reviews: 112,
		sku: 'FOOD-017',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'kitchen',
		stock: 89,
		image: 'https://images.unsplash.com/photo-1556909211-36987daf7b4d?w=500&h=500&fit=crop',
		rating: 4.5,
		reviews: 167,
		sku: 'HOME-011',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'kitchen',
		stock: 76,
		image: 'https://images.unsplash.com/photo-1594226801341-41427b4e5c22?w=500&h=500&fit=crop',
		rating: 4.6,
		reviews: 201,
		sku: 'HOME-012',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'body',
		stock: 200,
		image: 'https://images.unsplash.com/photo-1584305574647-0cc949a2bb9f?w=500&h=500&fit=crop',
		rating: 4.5,
		reviews: 178,
		sku: 'PC-008',
		inStock: true,
	...
	},
	{
		...
		stock: 45,
		image: 'https://images.unsplash.com/photo-1490633874781-1c63cc424610?w=500&h=500&fit=crop',
		rating: 4.6,
		reviews: 145,
		sku: 'BOOK-007',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'smart-home',
		stock: 125,
		image: 'https://images.unsplash.com/photo-1550534791-2677533605ab?w=500&h=500&fit=crop',
		rating: 4.5,
		reviews: 287,
		sku: 'SMRT-002',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'smart-home',
		stock: 42,
		image: 'https://images.unsplash.com/photo-1567925220744-d2f4dc98bbd3?w=500&h=500&fit=crop',
		rating: 4.8,
		reviews: 445,
		sku: 'SMRT-003',
		inStock: true,
	...
	},
	{
		...
		stock: 94,
		image: 'https://images.unsplash.com/photo-1623820919239-0d0ff10797a1?w=500&h=500&fit=crop',
		rating: 4.8,
		reviews: 623,
		sku: 'GAME-002',
		inStock: true,
	...
	},
	{
		...
		stock: 19,
		image: 'https://images.unsplash.com/photo-1616627561950-9f746e330187?w=500&h=500&fit=crop',
		rating: 4.5,
		reviews: 289,
		sku: 'GAME-005',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'audio',
		stock: 42,
		image: 'https://images.unsplash.com/photo-1539006839638-c8e46d72c7e7?w=500&h=500&fit=crop',
		rating: 4.6,
		reviews: 198,
		sku: 'AUDIO-003',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'fitness',
		stock: 72,
		image: 'https://images.unsplash.com/photo-1599058917765-a780eda07a3e?w=500&h=500&fit=crop',
		rating: 4.5,
		reviews: 289,
		sku: 'FITN-004',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'decor',
		stock: 95,
		image: 'https://images.unsplash.com/photo-1558211583-d26f610c1eb1?w=500&h=500&fit=crop',
		rating: 4.5,
		reviews: 234,
		sku: 'HOME-003',
		inStock: true,
	...
	// ========================================
	{
		...
		subcategory: 'snacks',
		stock: 142,
		image: 'https://images.unsplash.com/photo-1622484212850-eb596d769eab?w=500&h=500&fit=crop',
		rating: 4.5,
		reviews: 312,
		sku: 'FOOD-001',
		inStock: true,
	...
	},
	{
		...
		stock: 156,
		image: 'https://images.unsplash.com/photo-1517093157656-b9eccef91cb1?w=500&h=500&fit=crop',
		rating: 4.6,
		reviews: 289,
		sku: 'FOOD-004',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'camping',
		stock: 89,
		image: 'https://images.unsplash.com/photo-1530908295418-a12e326966ba?w=500&h=500&fit=crop',
		rating: 4.6,
		reviews: 267,
		sku: 'CAMP-005',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'kitchen-appliances',
		stock: 48,
		image: 'https://images.unsplash.com/photo-1570222094714-4b76d9703800?w=500&h=500&fit=crop',
		rating: 4.7,
		reviews: 434,
		sku: 'KITCH-004',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'pet-supplies',
		stock: 156,
		image: 'https://images.unsplash.com/photo-1601758124510-52d02ddb7cbd?w=500&h=500&fit=crop',
		rating: 4.5,
		reviews: 212,
		sku: 'PET-003',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'pet-supplies',
		stock: 51,
		image: 'https://images.unsplash.com/photo-1568393691622-c7ba131d63b4?w=500&h=500&fit=crop',
		rating: 4.6,
		reviews: 267,
		sku: 'PET-004',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'beverages',
		stock: 267,
		image: 'https://images.unsplash.com/photo-1568702846914-96b305d2uj38?w=500&h=500&fit=crop',
		rating: 4.4,
		reviews: 178,
		sku: 'SUPP-005',
		inStock: true,
	...
	// ========================================
	{
		...
		subcategory: 'games',
		stock: 67,
		image: 'https://images.unsplash.com/photo-1611891487122-207579d67d98?w=500&h=500&fit=crop',
		rating: 4.6,
		reviews: 234,
		sku: 'GAME-006',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'games',
		stock: 145,
		image: 'https://images.unsplash.com/photo-1494059980473-813e73ee784b?w=500&h=500&fit=crop',
		rating: 4.5,
		reviews: 189,
		sku: 'GAME-007',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'toys',
		stock: 89,
		image: 'https://images.unsplash.com/photo-1558507652-2d9626c4e67a?w=500&h=500&fit=crop',
		rating: 4.7,
		reviews: 267,
		sku: 'TOY-001',
		inStock: true,
	...
	},
	{
		...
		subcategory: 'automotive',
		stock: 56,
		image: 'https://images.unsplash.com/photo-1616486701797-0f33f61038ec?w=500&h=500&fit=crop',
		rating: 4.6,
		reviews: 345,
		sku: 'AUTO-004',
		inStock: true,
